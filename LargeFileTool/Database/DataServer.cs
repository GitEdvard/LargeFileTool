...
using LargeFileTool.Properties;
...
namespace LargeFileTool.Database
{
    ...
    public class Dataserver : LargeFileToolData
    {
        ...
        public DataReader GetAlleleVariants()
        {
            SqlCommandBuilder commandBuilder;

            commandBuilder = new SqlCommandBuilder("p_GetAlleleVariants");
